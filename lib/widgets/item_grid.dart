...
class ItemGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //Accessing object of Product_Provider to get data
    final product_provider_object = Provider.of<Product_Provider>(context);

    //Filtering products list based on value received
    final loadedProducts = _showFavourites
        ? product_provider_object.favouriteOnlyList
        : product_provider_object.list;
